class LoginApplicationView {
  ...
  nuevoArticulo() {
    ...
    alert(resultado.status === "OK" ? resultado.result : "Error: " + resultado.result);
  }
  ...
  crearUsuario() {
    ...
    if (!["Administrador", "Cliente", "Vendedor", "Trabajador"].includes(role)) {
